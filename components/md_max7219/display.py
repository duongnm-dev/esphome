...
from esphome.const import CONF_ID, CONF_INTENSITY, CONF_NUM_SCANS, CONF_LAMBDA, CONF_NUM_CHIPS

DEPENDENCIES = ["spi"]

md_max7219_ns = cg.esphome_ns.namespace("md_max7219")
MAX7219Component = md_max7219_ns.class_(
    ...
    display.BASIC_DISPLAY_SCHEMA.extend(
        {
            ...
            cv.Optional(CONF_NUM_SCANS, default=7): cv.int_range(min=0, max=7),
